function delta=sur_impe(theta,Height)
...
beta=0.3;%0.0077*f/1000+0.31;   % beta 1/km 
Zmax=100;%100;       % deep inside ionosphere
Zmin=50;%50;
...
aaa=[abs(delta_initial_11) abs(delta_initial_12);
    abs(delta_initial_21) abs(delta_initial_22)];
bbb=[angle(delta_initial_11)/pi*180 angle(delta_initial_12/pi*180);
    angle(delta_initial_21)/pi*180 angle(delta_initial_22)/pi*180];
save('delta_matrix.txt','aaa','-ascii')
save('phase.txt','bbb','-ascii')
